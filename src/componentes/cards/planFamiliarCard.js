export const cardPlanFamiliar = (planFamiliar) => {
    ...
    const estadoClase =
        planFamiliar.status_id == 3 ? "verPlan__estado--azul" :
        planFamiliar.status_id == 4 || planFamiliar.status_id == 7 ? "verPlan__estado--verde" :
        planFamiliar.status_id == 5 || planFamiliar.status_id == 6 ? "verPlan__estado--rojo" :
    ...
    const estadoTexto =
        planFamiliar.status_id == 5 ? "Rechz.Cambios" :
        planFamiliar.status_id == 6 ? "Rechz.Definitivo" :
        planFamiliar.status;
