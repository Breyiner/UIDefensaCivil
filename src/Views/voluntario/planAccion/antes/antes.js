...
export default async () => {
  ...
  await adjuntarOpc.adjuntarMiembros(
    miembro,
    `members/familyPlan/select/${id}`,
  );
  await adjuntarOpc.adjuntarFactorRiesgo(
    factorRiesgo,
    `riskFactors/familyPlan/select/${id}`,
  );
